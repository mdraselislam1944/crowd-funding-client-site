...
const AboutUs = () => {
    ...
    <div>
        ...
        <p className="text-xl lg:p-0 p-1">We believe that we can only bring about lasting solutions to the injustice of poverty by joining our efforts and expertise with others. For that reason, we work together with more than 4,100 partner organizations, as well as allies and communities in 90 countries.
            <br />
